...
class ResponseTest {
    ...
    void throwErrorIfEmptyArrayPassedIn() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new Response(new byte[]{});
        });
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new Response(new byte[]{1});
        });
    }

    @Test
    void isSuccessful() {
        Response response = new Response(new byte[]{(byte) 0x90, (byte) 0x00});
    ...
    @Test
    void getContent() {
        Response response = new Response(new byte[]{(byte) 0x11, (byte) 0x20, (byte) 0x90, (byte) 0x00});
        Assertions.assertTrue(response.isSuccessful());
